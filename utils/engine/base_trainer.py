...
def inject_default_parser(parser=None):
    ...
    parser.add_argument('--train_mode', type=str, default='half', help='(online half offline) select training mode for loop detection training')
    return parser
...
class BaseTrainer(abc.ABC):
    ...
    def register_model(self, model, incemental=False):
