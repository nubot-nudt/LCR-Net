...
from experiments.lcrnet.dataset_loop_closure import test_loop_closure_data_loader 
...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        cfg.feature_dir = cfg.lc_feature_dir + f'{self.args.dataset}'
        ...
        data_loader, neighbor_limits = test_loop_closure_data_loader(cfg, self.distributed, cfg.dataset)
