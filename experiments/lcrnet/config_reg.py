...
_C.output_dir = osp.join('/mnt/Mount/LCRNet-output','registration')
_C.snapshot_dir = osp.join(_C.output_dir, 'snapshots')
_C.log_dir = osp.join(_C.snapshot_dir, 'logs')
_C.event_dir = osp.join(_C.snapshot_dir, 'events')
_C.feature_dir = osp.join(_C.output_dir, 'features/registration/')
_C.lc_feature_dir = osp.join(_C.output_dir, 'features/loop_closing/')
...
_C.train.lc_text_root = '/loop_distance4'
_C.train.reg_text_root = '/icp10'
...
_C.test.lc_text_root = '/loop_overlap0.3'
_C.test.reg_text_root = '/icp10'
...
def make_cfg():
    ...
    _C.output_dir = osp.join(model_cfg.output_root,'registration')
    _C.snapshot_dir = osp.join(_C.output_dir, 'snapshots')
    _C.log_dir = osp.join(_C.snapshot_dir, 'logs')
    _C.event_dir = osp.join(_C.snapshot_dir, 'events')
    _C.feature_dir = osp.join(_C.output_dir, 'features/registration/')
