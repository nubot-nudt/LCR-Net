...
from experiments.lcrnet.modules.ops import index_select, apply_transform, pairwise_distance, get_point_to_node_indices
...
def get_node_correspondences_disance(
    ...
    if return_ind:
        ...
        ref_corr_indices = indices[0]
        src_corr_indices = indices[1]
        corr_indices = torch.stack([ref_corr_indices, src_corr_indices], dim=1)
        corr_distance = dist_mat[ref_corr_indices,src_corr_indices]
        return corr_indices, corr_distance
